...
class DeepLabv3_plus(nn.Module):
    def __init__(self, nInputChannels=3, n_classes=3, os=16, _print=True):
        if _print:
...
if __name__ == "__main__":
    model = DeepLabv3_plus(nInputChannels=3, n_classes=3, os=16, _print=True)
    model.eval()
