...
DFANet = DFANet(ch_cfg, 64, 3)  # todo 结合DFANet模型输入的需要，这个地方需要三个参数 channel_cfg, decoder_channel, num_classes
DFANet = DFANet.to(device)
criterion = nn.NLLLoss().to(device)
optimizer = optim.Adam(DFANet.parameters(), lr=1e-4)
